...
module tb_market_data_decoder;
    ...
    initial begin
        ...
        // Valid message with continuous payload bytes.
        start_message(16'd25);
        drive_payload(16, 1'b0);
        check_valid_message("continuous payload");

        // Valid message with an idle cycle between every payload byte.
        start_message(16'd25);
        drive_payload(16, 1'b1);
        check_valid_message("gapped payload");

        // Short UDP declaration must be rejected.
        idle_cycle();
        @(negedge clk);
        udp_length = 16'd24;
        market_header_valid = 1'b1;
        ...
        // Overlong UDP declaration must also be rejected.
        idle_cycle();
        @(negedge clk);
        udp_length = 16'd26;
        market_header_valid = 1'b1;
        ...
        // Early EOP must report an error and clear partially decoded state.
        idle_cycle();
        start_message(16'd25);
        ...
        // Allow the monitor to observe the final valid pulse count.
        idle_cycle();
        @(posedge clk);
        #1;
