module market_data_decoder (
    ...
    localparam [15:0] REQUIRED_UDP_LENGTH = 16'd25; // 8-byte UDP header + 17-byte message
    localparam [4:0]  LAST_PAYLOAD_BYTE   = 5'd16;
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (market_header_valid && market_packet) begin
                ...
                // This demonstrator implements exactly one fixed-width schema.
                ...
                if (eop_in && (payload_byte_index != LAST_PAYLOAD_BYTE)) begin
                    decoder_error     <= 1'b1;
                    decoding          <= 1'b0;
                    payload_byte_index <= 5'd0;
                    message_type      <= 8'd0;
                    ...
                    quantity          <= 32'd0;
                    sequence_number   <= 32'd0;
                end else if (payload_byte_index != LAST_PAYLOAD_BYTE) begin
